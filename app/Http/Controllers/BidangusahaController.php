...
/**
 * Description of BidangusahaController
 *
 * @author heryhandoko
 */
class BidangusahaController extends Controller {
    ...
    public function index() {
        return View('bidangusaha.index');
    }

    public function fetch(Request $request) {
        if ($request->ajax()) {
            $data = Bidangusaha::select('*');
    ...
    public function edit($id) {
        $Users = Bidangusaha::find($id);
        return response()->json($Users);
    }

    public function update(Request $request, Bidangusaha $datapost) {
        ...
        if ($request->id) {
            ...
            Bidangusaha::where('id', $request->id)->update($input);
            $status = 'update';
        } else {
