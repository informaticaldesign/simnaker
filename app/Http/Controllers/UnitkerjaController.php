...
/**
 * Description of UnitkerjaController
 *
 * @author heryhandoko
 */
class UnitkerjaController extends Controller {
    ...
    public function edit($id) {
        $Users = Unitkerja::find($id);
        return response()->json($Users);
    }

    public function update(Request $request, Unitkerja $datapost) {
        ...
        if ($request->id) {
            ...
            Unitkerja::where('id', $request->id)->update($input);
            $status = 'update';
        } else {
