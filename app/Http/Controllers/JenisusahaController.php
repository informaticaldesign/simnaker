...
/**
 * Description of JenisusahaController
 *
 * @author heryhandoko
 */
class JenisusahaController extends Controller {
    ...
    public function edit($id) {
        $Users = Jenisusaha::find($id);
        return response()->json($Users);
    }

    public function update(Request $request, Jenisusaha $datapost) {
        ...
        if ($request->id) {
            ...
            Jenisusaha::where('id', $request->id)->update($input);
            $status = 'update';
        } else {
