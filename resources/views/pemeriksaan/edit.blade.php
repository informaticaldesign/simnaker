...
@section('content')
{{ Form::open(array('route' => 'pemeriksaan.update','method'=>'post', 'enctype'=>"multipart/form-data", 'id'=>'form-input')) }}
        ...
        <div class="card card-outline">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="no_surat" placeholder="XXX/008/DTKT/WASNAKER/12/2021" value="{{ $datastore->no_surat }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="jml_lampiran" placeholder="Lampiran" value="{{ $datastore->jml_lampiran }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="perihal" placeholder="Perihal" value="{{ $datastore->perihal }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="no_spt" placeholder="XXX/008/SPT/WASNAKER/12/2021" value="{{ $datastore->no_spt }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="col-sm-6 form-control" name="tgl_spt" id="tgl_spt" placeholder="Tanggal SPT" value="{{ $datastore->tgl_spt }}">
        ...
        <div class="card card-outline">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="jns_pemeriksaan">
