...
<div class="row mb-2">
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <!-- <button type="button" class="btn btn-info btn-preview btn-action-preview" disabled><i class="far fa-eye"></i> Lihat</button> -->
        </ol>
    </div>
</div>
@stop
        ...
        <div class="card card-outline">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="no_surat" placeholder="XXX/008/DTKT/WASNAKER/12/2021" value="">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="jml_lampiran" placeholder="Lampiran" value="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="perihal" placeholder="Perihal" value="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="no_spt" placeholder="XXX/008/SPT/WASNAKER/12/2021" value="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="col-sm-6 form-control" name="tgl_spt" id="tgl_spt" placeholder="Tanggal SPT" value="">
