            ...
            <div class="resource-detail-container" style="padding: 10px 10px 10px 10px !important; background-color: white !important;">
                <div class="resource-detail container-fluid" style="padding: 0px 0px !important;">
                    <div class="resource-controls">
                        <span>Tampilan: </span>
                        <a class="view-tab ga-dataset-resource-view-selector active chart" data-ga="Chart" href="{{ url('dataset') }}/{{ $dataset->slug }}?view_id=4887311f-8757-4500-8a7e-886a6577a269">
                            <div></div>
                    ...
                    <div class="resource-view chart-view" >
                        <iframe frameborder="0" src="{{ url('ichart') }}/{{ $dataset->api_id }}"></iframe>
                    </div>
                </div>
            </div>
        </div>
