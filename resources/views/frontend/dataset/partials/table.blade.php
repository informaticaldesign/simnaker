            ...
            <div class="resource-detail-container" style="padding: 10px 10px 10px 10px !important; background-color: white !important;">
                <div class="resource-detail container-fluid" style="padding: 0px 0px !important;">
                    <div class="resource-controls">
                        ...
                        <a class="view-tab ga-dataset-resource-view-selector active table" data-ga="Table" href="{{ url('dataset') }}/{{ $dataset->slug }}?view_id=28bf9fb4-65a2-4378-a791-beac78cf789">
                            <div></div>
                            <img class="active" src="{{ asset('images/frontend/icons/resource_view_selectors/active/table.svg')}}">
                            <img class="inactive" src="{{ asset('images/frontend/icons/resource_view_selectors/inactive/table.svg')}}">
                            <img class="inactive hover" src="{{ asset('images/frontend/icons/resource_view_selectors/hover/table.svg')}}">
                        </a>
                        <a class="view-tab ga-dataset-resource-view-selector  maps" data-ga="Maps" href="{{ url('dataset') }}/{{ $dataset->slug }}?view_id=192ce991-fcd7-4aa0-9a37-628b9a483bca">
                            <div></div>
                    ...
                    <div class="resource-view table-view" >
                        <iframe frameborder="0" src="{{ url('itable') }}/{{ $dataset->api_id }}"></iframe>
                    </div>
                </div>
            </div>
        </div>
