...
@section('title', 'Open Data - Dataset')
@section('content')
            ...
            <section class="search-results">
                ...
                <div class="text-center">
                    <div class="pagination pagination-centered">
                        <ul> 
                            @if($page > 1)
                            <li><a href="{{ url('/dataset') }}?page={{ $page-1 }}">«</a></li>
                            @endif

                            @if($page < 5)
                            @for($x=1;$x<= ($page+2);$x++)
                            <li class="{{ $page==$x?'active':''}}"><a href="{{ url('/dataset') }}?page={{ $x }}">{{ $x }}</a></li> 
                            @endfor
                            <li class="disabled"><a href="#">...</a></li>
                            <li class="{{ $page==$totalpage?'active':''}}"><a href="{{ url('/dataset') }}?page={{ $totalpage }}">{{ $totalpage }}</a></li>
                            @endif

                            @if($page >= 5)
                            <li class="{{ $page==1?'active':''}}"><a href="{{ url('/dataset') }}?page=1">1</a></li> 
                            <li class="disabled"><a href="#">...</a></li>
