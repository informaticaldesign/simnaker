...
<div class="container mb-2" style="margin-top: 110px !important;">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Pendaftaran PJK3</li>
        </ol>
    </nav>
    <div class="row" style="--bs-gutter-x: 0rem;">
        <div class="card">
            <div class="card-header text-center">
                <h2>Form Pendaftaran PJK3</h2>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-1">
                            <label for="nib" class="col-sm-12 col-form-label">NIB (Nomor Induk Berusaha)<span class="text-danger">*</span></label>
                            <div class="col-sm-12">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="mb-1">
                            <label for="pemeriksa" class="col-sm-12 col-form-label">Nama Pemohon <span class="text-danger">*</span></label>
                            <div class="col-sm-12">
                        ...
                        <div class="mb-1">
                            <label for="nik_ktp_p" class="col-sm-12 col-form-label">NIK KTP Pemohon<span class="text-danger">*</span></label>
                            <div class="col-sm-12">
                        ...
                        <div class="mb-3">
                            <label for="filenpwp" class="col-sm-12 col-form-label">NPWP Badan Hukum <span class="text-danger">*</span></label>
                            <div class="col-sm-12">
                                <input type="file" class="form-control" accept="application/pdf" name="filenpwp">
                                <div class="invalid-feedback invalid-filenpwp"></div>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="fileakta" class="col-sm-12 col-form-label">Dokumen Pendukung <span class="text-danger">*</span></label>
                            <div class="col-sm-12">
                                <input type="file" class="form-control" accept="application/pdf" name="fileakta">
                                <div class="invalid-feedback invalid-fileakta"></div>
                                <div class="alert alert-warning mt-1">
                                    <h6><i class="icon fas fa-exclamation-triangle"></i> Informasi!</h6>
                                    <ul>
                                        <li>Dokumen pendukung berupa Akta Pendirian dan SK Pengesahan yang dikeluarkan oleh
                                            <ul>
                                                <li>Kemenkunham, jika PT dan Yayasan</li>
                                                <li>Kementrian Koperasi, jika Koperasi</li>
                                                <li>Pengadilan Negeri, jika CV</li>
                                            </ul>
                                        </li>
                                        <li>Dokumen pendukung yang di upload berformat *.pdf </li>
                                        <li>Maksimal ukuran file untuk di upload tidak boleh lebih dari 2MB</li>
                                        <li>Untuk dokumen yang lebih dari 1 file, bisa di gabungin menjadi 1 file format pdf.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="mb-1">
                            <div class="col-sm-12">
                                <button type="button" class="btn btn-primary float-end btn-action-daftar" style="background-color:#1e375b; border-color: #1e375b;">
            ...
            success: function (result) {
                if (result.success) {
                    Swal.fire({
                        ...
                        text: "Kami akan melakukan verifikasi dokumen dalam 1x24 jam. Mohon periksa email Anda yang secara berkala. Hasil verifikasi akan dikirimkan melalui Email tersebut.",
                        icon: 'success',
                    ...
                    Swal.fire({
                        title: 'Gagal',
                        text: "Pendaftaran PJK3 gagal disimpan",
                        icon: 'error',
                        showCancelButton: false,
