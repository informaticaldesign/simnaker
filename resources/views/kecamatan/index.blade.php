    ...
    <div class="col-12">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title">Kecamatan <small>list</small></h3>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="kec_code" class="col-sm-12 control-label">Kode Kecamatan</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control" name="kec_code" placeholder="Kode Kecamatan" maxlength="18">
                        <div class="invalid-feedback invalid-kec_code"></div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="name" class="col-sm-12 control-label">Nama Kecamatan</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control" id="name" name="name" placeholder="Provinsi" maxlength="256">
...
<script>
    $(function () {
        ...
        var _dataTable = $('.data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.kecamatan.fetch') }}",
            columns: [
                {data: 'id', name: 'id'},
                {data: 'prov_name', name: 'prov_name'},
                {data: 'city_name', name: 'city_name'},
                {data: 'kec_code', name: 'kec_code'},
                {data: 'name', name: 'name'},
        ...
        $('body').on('click', '.action-edit', function () {
            ...
            var id = $(this).data('id');
            $.get("/admin/kecamatan" + '/' + id + '/edit', function (data) {
        ...
        $('body').on('click', '.action-view', function () {
            ...
            var id = $(this).data('id');
            $.get("/admin/kecamatan" + '/' + id + '/edit', function (data) {
                $('#modelHeading').html("View Kecamatan");
                $('#ajaxModel').modal('show');
                var _cityCodeVal = '';
                $("form#MyForm :input").each(function () {
                    var inputName = $(this).attr('name');
