...
<div class="row">
    <div class="col-12">
        <div class="card card-primary card-outline">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                {{ Form::open(array('route' => 'admin.infografis.update','method'=>'post', 'enctype'=>"multipart/form-data")) }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="name" class="form-control" id="name" placeholder="Nama" value="{{ $topic->title }}">
                        @if ($errors->has('name'))
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="slug" class="form-control" id="label" placeholder="Slug" value="{{ $topic->slug }}">
                        @if ($errors->has('slug'))
