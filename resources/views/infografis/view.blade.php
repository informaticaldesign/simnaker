    ...
    <div class="col-12">
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label for="label" class="col-sm-2 col-form-label">Infografis</label>
                    <div class="col-sm-10">
                        <input type="text" name="id_organization" class="form-control" id="id_organization" placeholder="Infografis" disabled value="{{ $topic->organizations_name }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="label" class="col-sm-2 col-form-label">Thumbnail<span class="text-danger">*</span></label>
                    <div class="col-sm-10">
                        <img src="{{ asset('uploads/infografiks/thumbnails') }}/{{ $topic->icon }}" width="150" height="150" class="img-fluid mb-2" alt="black sample">
                    </div>
                </div>
                @if($details->count() > 0)
                <div class="card p-2">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <img src="{{ asset('uploads/infografiks/details') }}/{{ $val->fullpath }}" width="150" height="150" class="img-fluid mb-2 m-1" alt="black sample">
                            @endforeach
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <a href="{{ url('admin/infografis') }}" class="btn btn-warning float-right">Cancel</a>
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
