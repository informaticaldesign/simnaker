    ...
    <div class="col-12">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title">Unit Kerja <small>list</small></h3>
...
<script>
    $(function () {
        ...
        $('body').on('click', '.action-edit', function () {
            ...
            var id = $(this).data('id');
            $.get("unitkerja" + '/' + id + '/edit', function (data) {
                $('#modelHeading').html("Edit Unit Kerja");
        ...
        $('body').on('click', '.action-view', function () {
            ...
            var id = $(this).data('id');
            $.get("unitkerja" + '/' + id + '/edit', function (data) {
                $('#modelHeading').html("View Unit Kerja");
                $('#ajaxModel').modal('show');
                $('#id').val(data.id);
                $('#name').val(data.name);
        ...
        $('body').on('click', '.btn-action-add', function () {
            $('#modelHeading').html("Add Unit Kerja");
            $('#ajaxModel').modal('show');
            $('#id').val('');
            $('button.btn-submit-update').show();
            $('button.btn-save').html('<i class="far fa-save"></i> Simpan');
