...
<div class="row">
    <div class="col-12">
        <div class="card card-primary card-outline">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                {{ Form::open(array('route' => 'admin.dataset.update','method'=>'post', 'enctype'=>"multipart/form-data")) }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="title" class="form-control" id="title" placeholder="Judul" value="{{ $dataset->title }}">
                        @if ($errors->has('name'))
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="id_topic" name="id_topic">
                            ...
                            <option value="{{ $key }}" {{$dataset->id_topic == $key ? 'selected' :'' }}>{{ $topik }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="id_organization" name="id_organization">
                            ...
                            <option value="{{ $key }}" {{$dataset->id_organization == $key ? 'selected' :'' }}>{{ $organization }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="api_id" class="form-control" id="api_id" placeholder="API Key" value="{{ $dataset->api_id }}">
