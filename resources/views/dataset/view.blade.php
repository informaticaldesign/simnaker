        ...
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="title" class="form-control" id="title" placeholder="Judul" disabled value="{{ $dataset->title }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="label" class="col-sm-2 col-form-label">Deskripsi</label>
                    <div class="col-sm-10">
                        <textarea id="summernote" class="summernote" name="description">{!! $dataset->description !!}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="label" class="col-sm-2 col-form-label">Topik</label>
                    <div class="col-sm-10">
                        <input type="text" name="id_topic" class="form-control" id="id_topic" placeholder="Topik" disabled value="{{ $dataset->topic_name }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="label" class="col-sm-2 col-form-label">Organisasi</label>
                    <div class="col-sm-10">
                        <input type="text" name="id_organization" class="form-control" id="id_organization" placeholder="Organisasi" disabled value="{{ $dataset->organizations_name }}">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="api_id" class="form-control" id="api_id" placeholder="API Key" value="{{ $dataset->api_id }}" disabled>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <!--                        <a href="" class="btn btn-danger"></a>-->
                        <a href="{{ url('admin/dataset') }}" class="btn btn-warning float-right">Cancel</a>
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
