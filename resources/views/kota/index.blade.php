    ...
    <div class="col-12">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title">Kota <small>list</small></h3>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="city_code" class="col-sm-12 control-label">Kode Kota/Kab</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control" id="city_code" name="city_code" placeholder="Kode Kota" maxlength="18">
                        <div class="invalid-feedback invalid-city_code"></div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="name" class="col-sm-12 control-label">Nama Kota/Kab</label>
                    <div class="col-sm-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <select class="form-control" name="prov_code">
...
<script>
    $(function () {
        ...
        $('body').on('click', '.action-edit', function () {
            ...
            var id = $(this).data('id');
            $.get("kota" + '/' + id + '/edit', function (data) {
