...
<div class="row mb-2">
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Bank Nota 1</li>
        </ol>
    </div>
</div>
@stop
    ...
    <div class="col-12">
        <div class="card card-primary card-outline" style="border-top: 3px solid #1e375a !important;">
            <div class="card-header">
                <h3 class="card-title">Bank Nota 1<small>list</small></h3>
                <div class="card-tools">
                    <a href="{{ url('/banknota/listbn/create') }}" class="btn btn-tool"><i class="fas fa-plus text-primary"></i></a>
...
<script>
    $(function () {
        ...
        $('.data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('banknota.listbn.fetch') }}",
            columns: [
        ...
        $('body').on('click', '.action-delete', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: "{{ url('banknota/listbn/destroy') }}" + "/" + id,
                        dataType: 'JSON',
