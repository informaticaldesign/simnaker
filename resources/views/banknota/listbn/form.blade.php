                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="perihal" id="perihal" value="{{ isset($jenis->perihal)?$jenis->perihal:'Nota Pemeriksaan' }}">
                                        ...
                                        <div class="row row-jenis-bank-nota mt-1 row-0">
                                            <div class="col-10">
                                                <select class="form-control" name="jenis_id[0]">
                                                    <option value="" selected>Pilih Jenis Bank Nota</option>
