...
<div class="row">
    <div class="col-12">
        <div class="card card-primary card-outline">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                {{ Form::open(array('route' => 'admin.organisasi.update','method'=>'post', 'enctype'=>"multipart/form-data")) }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        @endif
                        <br><br>
                        <img src="{{ asset('uploads/organisasi') }}/{{ $topic->icon }}" width="150" height="150" class="img-fluid mb-2" alt="black sample">
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
