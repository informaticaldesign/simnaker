        ...
        <div class="row">
            <div class="col-12">
                <div class="invoice p-3 mb-3" style="width: 21cm;">
                    ...
                    <table width="100%" style="margin-top: 5px; margin-left: auto;margin-right: auto; font-family: 'Times New Roman';" cellspacing='0'>
                        <tbody>
                            <tr style="height:20px !important;">
                                <td style="text-align: left; font-size: 12pt; font-weight: bold; width:15%;">Nomor</td>
                                <td style="text-align: left; font-size: 12pt; width:45%">: {{ $notif->no_idx }}</td>
                                <td style="text-align: left; font-size: 12pt;"><b>Kepada:</b></td>
                                <td style="text-align: left; font-size: 12pt;"></td>
                            </tr>
                            <tr style="height:20px !important;">
                                <td style="text-align: left; font-size: 12pt; font-weight: bold; width:15%;">Lampiran</td>
                                <td style="text-align: left; font-size: 12pt; width:45%">: -</td>
                                <td style="text-align: left; font-size: 12pt;"><b>Yth. Sdr. Pimpinan Perusahaan</b></td>
                                <td style="text-align: left; font-size: 12pt;"></td>
                            </tr>
                            <tr style="height:20px !important;">
                                <td style="text-align: left; font-size: 12pt; font-weight: bold; width:15%;">Sifat</td>
                                <td style="text-align: left; font-size: 12pt; width:45%">: Penting</td>
                                <td style="text-align: left; font-size: 12pt;">{{ $renja->perusahaan }}</td>
                                <td style="text-align: left; font-size: 12pt;"></td>
                            </tr>
                            <tr style="height:20px !important;">
                                <td style="text-align: left; font-size: 12pt; font-weight: bold; width:15%;">Perihal</td>
                                <td style="text-align: left; font-size: 12pt; width:45%; text-decoration: underline">: Pemeriksaan Ketenagakerjaan</td>
                                <td style="text-align: left; font-size: 12pt;"><b>Di - </b></td>
                                <td style="text-align: left; font-size: 12pt;"></td>
                            </tr>
                            <tr style="height:20px !important;">
                                <td style="text-align: left; font-size: 12pt; font-weight: bold; width:15%;"></td>
                                <td style="text-align: left; font-size: 12pt; width:45%; text-decoration: underline"></td>
                    ...
                    <p style="font-family: 'Times New Roman'; font-size: 12pt; margin-bottom: 0px;">Untuk itu diminta agar Saudara mempersiapkan data-data antara lain sebagai berikut :</p>
                    ...
                    <p style="font-family: 'Times New Roman'; text-indent: 2em; font-size: 12pt; margin-bottom: 0px;">Demikian   pemberitahuan  ini disampaikan untuk mendapat perhatian dan dipersiapkan sebagaimana mestinya. </p>
                    <p style="font-family: 'Times New Roman'; font-size: 12pt;">Atas perhatian dan kerjasamanya diucapkan terimakasih.</p>
                    <table width="100%" style="margin-top: 5px; margin-left: auto;margin-right: auto; font-family: 'Times New Roman';" cellspacing='0'>
                        <tbody>
                            <tr style="height:20px !important;">
