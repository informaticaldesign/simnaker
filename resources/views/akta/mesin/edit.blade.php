    ...
    <div class="col-md-12">
        <div class="card card-outline">
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label for="jml_cabang" class="{{ $widthLabel }}">Data Mesin Produksi <span class="text-danger">*</span> <button class="btn btn-md btn-primary" id="addBtn" type="button" value="0">Tambah Data</button>
                    </label>
                </div>
                <div class="form-group row">
                    <div class="col-md-12 table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody id="tbody">
                                ...
                                <tr>
                                    <td>
                                        {{ Form::text('nama_motor['.$key.']', $val->nama_motor ,['class'=>'form-control','id'=>'nama_motor']); }}
                                        <div class="invalid-feedback invalid-nama_motor.0"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('jml_motor['.$key.']',$val->jml_motor,['class'=>'form-control','id'=>'jml_motor']); }}
                                        <div class="invalid-feedback invalid-jml_motor.0"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('daya_motor['.$key.']',$val->daya_motor,['class'=>'form-control','id'=>'daya_motor']); }}
                                        <div class="invalid-feedback invalid-daya_motor.0"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('ttl_daya_motor['.$key.']',$val->ttl_daya_motor,['class'=>'form-control','id'=>'ttl_daya_motor']); }}
                                        <div class="invalid-feedback invalid-ttl_daya_motor.0"></div>
                                    </td>
                                    <td>
                                        {{ Form::text('keterangan['.$key.']',$val->keterangan,['class'=>'form-control','id'=>'keterangan']); }}
