...
<input type="hidden" name="menu" value="persetujuan">
<?php
            ...
            <div class="card-body">
                ...
                <div class="form-group row mt-1">
                    ...
                    <div class="{{ $widthField }}">
                        {{ Form::select('company_id',[],$data->company_id,['class'=>'form-control','id'=>'company_id']); }}
                ...
                <div class="form-group row">
                    ...
                    <div class="{{ $widthField }}">
                        {{ Form::textarea('address', $data->address,['class'=>'form-control','rows'=>3,'id'=>'address']); }}
                ...
                <div class="form-group row">
                    ...
                    <div class="{{ $widthField }}">
                        {{ Form::text('nama_pemilik',$data->nama_pemilik,['class'=>'form-control','id'=>'nama_pemilik']); }}
                ...
                <div class="form-group row">
                    ...
                    <div class="{{ $widthField }}">
                        {{ Form::textarea('add_pemilik', $data->add_pemilik,['class'=>'form-control','rows'=>3,'id'=>'add_pemilik']); }}
                ...
                <div class="form-group row">
                    ...
                    <div class="{{ $widthField }}">
                        {{ Form::text('nama_pengurus',$data->nama_pengurus,['class'=>'form-control','id'=>'nama_pengurus']); }}
                ...
                <div class="form-group row">
                    ...
                    <div class="{{ $widthField }}">
                        {{ Form::textarea('add_pengurus', $data->add_pengurus,['class'=>'form-control','rows'=>3,'id'=>'add_pengurus']); }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        {{ Form::text('jenis_usaha',$data->jenis_usaha,['class'=>'form-control','id'=>'jenis_usaha']); }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        {{ Form::date('tgl_berdiri',$data->tgl_berdiri,['class'=>'form-control','id'=>'tgl_berdiri']); }}
                ...
                <div class="form-group row">
                    ...
                    <div class="{{ $widthField }}">
                        {{ Form::text('no_akte',$data->no_akte,['class'=>'form-control','id'=>'no_akte']); }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        {{ Form::number('jml_cabang',$data->jml_cabang,['class'=>'form-control','id'=>'jml_cabang']); }}
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ Form::number('wni_l_bul_a',$data->wni_l_bul_a,['class'=>'form-control bulanan_l','id'=>'wni_l_bul_a']); }}
                                        <div class="invalid-feedback invalid-wni_l_bul_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wni_l_bul_d',$data->wni_l_bul_d,['class'=>'form-control bulanan_l','id'=>'wni_l_bul_d']); }}
                                        <div class="invalid-feedback invalid-wni_l_bul_d"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wni_p_bul_a',$data->wni_p_bul_a,['class'=>'form-control bulanan_p','id'=>'wni_p_bul_a']); }}
                                        <div class="invalid-feedback invalid-wni_p_bul_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wni_p_bul_d',$data->wni_p_bul_d,['class'=>'form-control bulanan_p','id'=>'wni_p_bul_d']); }}
                                        <div class="invalid-feedback invalid-wni_p_bul_d"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_l_bul_a',$data->wna_l_bul_a,['class'=>'form-control bulanan_l','id'=>'wna_l_bul_a']); }}
                                        <div class="invalid-feedback invalid-wna_l_bul_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_l_bul_d',$data->wna_l_bul_d,['class'=>'form-control bulanan_l','id'=>'wna_l_bul_d']); }}
                                        <div class="invalid-feedback invalid-wna_l_bul_d"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_p_bul_a',$data->wna_p_bul_a,['class'=>'form-control bulanan_p','id'=>'wna_p_bul_a']); }}
                                        <div class="invalid-feedback invalid-wna_p_bul_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_p_bul_d',$data->wna_p_bul_d,['class'=>'form-control bulanan_p','id'=>'wna_p_bul_d']); }}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ Form::number('wni_l_bor_a',$data->wni_l_bor_a,['class'=>'form-control borongan_l','id'=>'wni_l_bor_a']); }}
                                        <div class="invalid-feedback invalid-wni_l_bor_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wni_l_bor_d',$data->wni_l_bor_d,['class'=>'form-control borongan_l','id'=>'wni_l_bor_d']); }}
                                        <div class="invalid-feedback invalid-wni_l_bor_d"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wni_p_bor_a',$data->wni_p_bor_a,['class'=>'form-control borongan_p','id'=>'wni_p_bor_a']); }}
                                        <div class="invalid-feedback invalid-wni_p_bor_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wni_p_bor_d',$data->wni_p_bor_d,['class'=>'form-control borongan_p','id'=>'wni_p_bor_d']); }}
                                        <div class="invalid-feedback invalid-wni_p_bor_d"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_l_bor_a',$data->wna_l_bor_a,['class'=>'form-control borongan_l','id'=>'wna_l_bor_a']); }}
                                        <div class="invalid-feedback invalid-wna_l_bor_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_l_bor_d',$data->wna_l_bor_d,['class'=>'form-control borongan_l','id'=>'wna_l_bor_d']); }}
                                        <div class="invalid-feedback invalid-wna_l_bor_d"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_p_bor_a',$data->wna_p_bor_a,['class'=>'form-control borongan_p','id'=>'wna_p_bor_a']); }}
                                        <div class="invalid-feedback invalid-wna_p_bor_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_p_bor_d',$data->wna_p_bor_d,['class'=>'form-control borongan_p','id'=>'wna_p_bor_d']); }}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ Form::number('wni_l_hl_a',$data->wni_l_hl_a,['class'=>'form-control harian_l','id'=>'wni_l_hl_a']); }}
                                        <div class="invalid-feedback invalid-wni_l_hl_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wni_l_hl_d',$data->wni_l_hl_d,['class'=>'form-control harian_l','id'=>'wni_l_hl_d']); }}
                                        <div class="invalid-feedback invalid-wni_l_hl_d"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wni_p_hl_a',$data->wni_p_hl_a,['class'=>'form-control harian_p','id'=>'wni_p_hl_a']); }}
                                        <div class="invalid-feedback invalid-wni_p_hl_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wni_p_hl_d',$data->wni_p_hl_d,['class'=>'form-control harian_p','id'=>'wni_p_hl_d']); }}
                                        <div class="invalid-feedback invalid-wni_p_hl_d"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_l_hl_a',$data->wna_l_hl_a,['class'=>'form-control harian_l','id'=>'wna_l_hl_a']); }}
                                        <div class="invalid-feedback invalid-wna_l_hl_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_l_hl_d',$data->wna_l_hl_d,['class'=>'form-control harian_l','id'=>'wna_l_hl_d']); }}
                                        <div class="invalid-feedback invalid-wna_l_hl_d"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_p_hl_a',$data->wna_p_hl_a,['class'=>'form-control harian_p','id'=>'wna_p_hl_a']); }}
                                        <div class="invalid-feedback invalid-wna_p_hl_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_p_hl_d',$data->wna_p_hl_d,['class'=>'form-control harian_p','id'=>'wna_p_hl_d']); }}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ Form::number('wni_l_pkwt_a',$data->wni_l_pkwt_a,['class'=>'form-control pkwt_l','id'=>'wni_l_pkwt_a']); }}
                                        <div class="invalid-feedback invalid-wni_l_pkwt_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wni_l_pkwt_d',$data->wni_l_pkwt_d,['class'=>'form-control pkwt_l','id'=>'wni_l_pkwt_d']); }}
                                        <div class="invalid-feedback invalid-wni_l_pkwt_d"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wni_p_pkwt_a',$data->wni_p_pkwt_a,['class'=>'form-control pkwt_p','id'=>'wni_p_pkwt_a']); }}
                                        <div class="invalid-feedback invalid-wni_p_pkwt_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wni_p_pkwt_d',$data->wni_p_pkwt_d,['class'=>'form-control pkwt_p','id'=>'wni_p_pkwt_d']); }}
                                        <div class="invalid-feedback invalid-wni_p_pkwt_d"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_l_pkwt_a',$data->wna_l_pkwt_a,['class'=>'form-control pkwt_l','id'=>'wna_l_pkwt_a']); }}
                                        <div class="invalid-feedback invalid-wna_l_pkwt_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_l_pkwt_d',$data->wna_l_pkwt_d,['class'=>'form-control pkwt_l','id'=>'wna_l_pkwt_d']); }}
                                        <div class="invalid-feedback invalid-wna_l_pkwt_d"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_p_pkwt_a',$data->wna_p_pkwt_a,['class'=>'form-control pkwt_p','id'=>'wna_p_pkwt_a']); }}
                                        <div class="invalid-feedback invalid-wna_p_pkwt_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_p_pkwt_d',$data->wna_p_pkwt_d,['class'=>'form-control pkwt_p','id'=>'wna_p_pkwt_d']); }}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ Form::number('wni_l_pkwtt_a',$data->wni_l_pkwtt_a,['class'=>'form-control pkwtt_l','id'=>'wni_l_pkwtt_a']); }}
                                        <div class="invalid-feedback invalid-wni_l_pkwtt_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wni_l_pkwtt_d',$data->wni_l_pkwtt_d,['class'=>'form-control pkwtt_l','id'=>'wni_l_pkwtt_d']); }}
                                        <div class="invalid-feedback invalid-wni_l_pkwtt_d"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wni_p_pkwtt_a',$data->wni_p_pkwtt_a,['class'=>'form-control pkwtt_p','id'=>'wni_p_pkwtt_a']); }}
                                        <div class="invalid-feedback invalid-wni_p_pkwtt_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wni_p_pkwtt_d',$data->wni_p_pkwtt_d,['class'=>'form-control pkwtt_p','id'=>'wni_p_pkwtt_d']); }}
                                        <div class="invalid-feedback invalid-wni_p_pkwtt_d"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_l_pkwtt_a',$data->wna_l_pkwtt_a,['class'=>'form-control pkwtt_l','id'=>'wna_l_pkwtt_a']); }}
                                        <div class="invalid-feedback invalid-wna_l_pkwtt_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_l_pkwtt_d',$data->wna_l_pkwtt_d,['class'=>'form-control pkwtt_l','id'=>'wna_l_pkwtt_d']); }}
                                        <div class="invalid-feedback invalid-wna_l_pkwtt_d"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_p_pkwtt_a',$data->wna_p_pkwtt_a,['class'=>'form-control pkwtt_p','id'=>'wna_p_pkwtt_a']); }}
                                        <div class="invalid-feedback invalid-wna_p_pkwtt_a"></div>
                                    </td>
                                    <td>
                                        {{ Form::number('wna_p_pkwtt_d',$data->wna_p_pkwtt_d,['class'=>'form-control pkwtt_p','id'=>'wna_p_pkwtt_d']); }}
                ...
                <div class="form-group row">
                    ...
                    <div class="{{ $widthField }}">
                        {{ Form::text('gaya_gerak',$data->gaya_gerak,['class'=>'form-control','id'=>'gaya_gerak']); }}
                ...
                <div class="form-group row">
                    ...
                    <div class="{{ $widthField }}">
                        {{ Form::text('jns_pesawat_tenaga',$data->jns_pesawat_tenaga,['class'=>'form-control','id'=>'jns_pesawat_tenaga']); }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        {{ Form::number('jml_pesawat_tenaga',$data->jml_pesawat_tenaga,['class'=>'form-control','id'=>'jml_pesawat_tenaga']); }}
                ...
                <div class="form-group row">
                    ...
                    <div class="{{ $widthField }}">
                        {{ Form::text('bahan_baku',$data->bahan_baku,['class'=>'form-control','id'=>'bahan_baku']); }}
                        <div class="invalid-feedback invalid-bahan_baku"></div>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="bahan_baku" class="{{ $widthLabel }}">Status Persetujuan <span class="text-danger">*</span></label>
                    <div class="{{ $widthField }}">
                ...
                <div class="form-group row mt-1 field-disposisi d-none">
                    <label for="employee_id" class="{{ $widthLabel }}">Disposisi Ke <span class="text-danger">*</span></label>
                    <div class="{{ $widthField }}">
                        {{ Form::select('employee_id',[],'',['class'=>'form-control','id'=>'employee_id']); }}
                        <div class="invalid-feedback invalid-employee_id"></div>
                    </div>
                </div>
                <div class="form-group row field-reason d-none">
                    <label for="reason" class="{{ $widthLabel }}">Alasan</label>
                    <div class="{{ $widthField }}">
                        {{ Form::textarea('reason', $data->reason,['class'=>'form-control','rows'=>3,'id'=>'reason']); }}
                ...
                <div class="form-group row text-right">
                    <div class="col-md-12">
                        <a href="{{ url('/admin/pengawasan/persetujuan/list') }}" class="btn btn-default"><i class="fa fa-times"></i> Batal</a>&nbsp;
                        <button type="button" class="btn btn-success btn-save btn-action-submit" value="terkirim"><i class="far fa-save"></i> Submit</button>&nbsp;
                    </div>
                </div>
                <!-- /.card-body -->
            </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            window.location.href = "{{ url('/admin/pengawasan/persetujuan/list') }}";
                        } else {
