        ...
        <div class="card card-outline">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_pemeriksa" placeholder="Nama Pegawai Pengawas" disabled value="Heri Handoko">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tgl_pemeriksaan" id="tgl_pemeriksaan" placeholder="Tanggal Pemeriksaan">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <select class="form-control" name="perusahaan">
                        ...
                        <option value="2">PT Pasti Makmur</option>
                    </select>
