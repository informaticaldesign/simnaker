...
<div class="row mb-2">
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ url('company') }}">UPT</a></li>
        </ol>
    </div>
</div>
@stop
        ...
        <div class="card">
            <div class="card-body">
                <div class="alert alert-info alert-dismissible">
                    ...
                    Silahkan pilih atau checked untuk menambah pegawai di {{ $company->name }}.
                </div>
...
<script>
    ...
    $(function () {
        ...
        $('#dtBasicExample tbody').on('click', 'input[type="checkbox"]', function (e) {
            ...
            var _msg = 'Pegawai berhasil dihapus';
            if (this.checked) {
                _status = 'checked';
                _msg = 'Pegawai berhasil ditambahkan';
            }

            $.ajax({
                url: "/admin/upt/anggota",
                method: 'POST',
                data: {
                    biodata_id: $(this).val(),
                    upt_id: '{{ $company->id }}',
